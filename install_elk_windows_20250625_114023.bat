...
REM Generated on: 2025-06-25 11:40:22
REM ELK Version: 8.11.0
...
set "LOGSTASH_BEATS_PORT=5044"
set "LOGSTASH_SYSLOG_PORT=514"
set "INSTALL_DIR=C:\ELK"
set "CLUSTER_NAME=elk-cluster"
set "NODE_NAME=elk-node-1"
set "ELASTICSEARCH_HEAP=auto"
set "LOGSTASH_HEAP=2g"
